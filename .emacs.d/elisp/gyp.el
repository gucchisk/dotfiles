...
(defvar python-indent-calculate-levels nil)
(defvar python-continuation-offset nil)
...
(defadvice python-indent-calculate-levels (after gyp-outdent-closing-parens
  ...
  (when (and (eq major-mode 'gyp-mode)
    ...
    (setf (first python-indent-calculate-levels)
          (- (first python-indent-calculate-levels) python-continuation-offset))))
